...
var TeamComponent = (function () {
    function TeamComponent(partyService) {
        this.partyService = partyService;
        this.parties = [];
        //partySummary : PartySummaryList = new PartySummaryList;
        this.partyGroup01Summary = [];
        this.partyGroup02Summary = [];
        this.partyGroup03Summary = [];
        this.partyGroup04Summary = [];
        this.partyTags = [];
        this.selectedPlacement = 'Offshore';
    ...
    TeamComponent.prototype.ngOnInit = function () {
        ...
        this.partyService.getPartySummary()
            .then(function (partySummary) {
            _this.partyGroup01Summary = partySummary.group01;
            _this.partyGroup02Summary = partySummary.group02;
            _this.partyGroup03Summary = partySummary.group03;
            _this.partyGroup04Summary = partySummary.group04;
            _this.partyTags = partySummary.partytags;
        });
        this.partyService.getParties('WorkersComp')
            ...
            _this.selectedPlacement = 'Offshore';
            _this.party.Group = parties[0].Group;
            _this.party.Placement = _this.selectedPlacement;
        });
    };
    ...
    TeamComponent.prototype.showOnshorePartySummary = function (team) {
        var _this = this;
        team = team.trim();
        if (!team) {
            return;
        }
        this.partyService.getPartiesOnshore(team)
            .then(function (parties) {
            _this.selectedTeam = team;
            _this.party.Team = team;
            _this.selectedPlacement = 'Onshore';
            _this.selectedParties = parties;
            _this.party.Placement = _this.selectedPlacement;
            _this.party.Group = 'Onshore';
        });
    };
    TeamComponent.prototype.refreshSelectedTag = function (tag) {
        var _this = this;
        tag = tag.trim();
        if (!tag) {
            return;
        }
        this.partyService.getPartiesByTag(tag)
            .then(function (parties) {
            _this.selectedTag = tag;
            _this.selectedTeam = '';
            _this.party.Team = '';
            _this.selectedParties = parties;
        });
...
/* unused harmony export PartySummaryList */
var Party = (function () {
    function Party() {
    }
    return Party;
...
var PartySummaryList = (function () {
    function PartySummaryList() {
    }
...
var PartyService = (function () {
    function PartyService(http) {
        ...
        this.partiesTagUrl = '/partiesTagApi'; // URL to web api
        this.partyURL = '/partyapi';
        this.partySummaryURL = '/partySummaryapi';
    }
    PartyService.prototype.getParties = function (team) {
        var url = this.partiesUrl + "/" + team + "/Offshore";
        return this.http.get(url)
            .toPromise()
            .then(function (response) { return response.json(); })
            .catch(this.handleError);
    };
    PartyService.prototype.getPartiesOnshore = function (team) {
        var url = this.partiesUrl + "/" + team + "/Onshore";
        return this.http.get(url)
            .toPromise()
            .then(function (response) { return response.json(); })
            .catch(this.handleError);
    };
    PartyService.prototype.getPartiesByTag = function (tag) {
        var url = this.partiesTagUrl + "/" + tag;
        return this.http.get(url)
            .toPromise()
            .then(function (response) { return response.json(); })
            .catch(this.handleError);
