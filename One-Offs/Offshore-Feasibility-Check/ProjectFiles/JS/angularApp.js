    var app = angular.module('scoreCardApp', ['ui.router','ui.bootstrap']);
                    ...
                    link: function (scope, element) {
                        Highcharts.chart(element[0], {
                            ...
                            series: [{
								...
								type: 'spline',
								name: 'Cannot be offshored',
								data:  [[0, 40],[40, 0]]
							},{
								type: 'spline',
								name: 'Can be offshored',
								data: [[3, 80],[80, 0]]
							}]
                        });
                    }
        ...
        app.factory('webServiceCall',['$http','$window',function($http,$window){
            var o = {
                allScores: [],
                slides:[],
                score: {},
			...
			o.updateAllBatches = function(score){
			  return $http.post('/UpdateAllBatches', angular.toJson(score)).success(function(status){
			   alert("Thanks for your time in completing this exercise. Your score has been updated in the system.");
